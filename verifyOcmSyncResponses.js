...
program
  ...
  .option('-v, --verbose', 'detailed log, e.g. number of entries per UICFilePath+ListPath')
  .parse(process.argv);
        ...
        files.forEach(function (sFileName) {
            ...
            if (stat.isFile()) {
                ...
                if (aData && aData.length > 0) {
                    ...
                    iTotalEntries = iTotalEntries + aData.length;
                ...
                if (bErrorFound === false && program.verbose) {
